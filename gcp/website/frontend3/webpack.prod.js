...
module.exports = {
  ...
  plugins: [
    new CopyPlugin({
      patterns: [
        { from: './src/templates/*.html', to: '[name].html', globOptions: { ignore: ['**/base.html', '**/triage.html', '**/generate.html'] } },
    ...
    new HtmlWebpackPlugin({
      ...
      chunks: ['main'],
      excludeChunks: ['linter', 'generate', 'triage'],
    }),
    new HtmlWebpackPlugin({
      filename: 'linter.html',
      template: './src/templates/linter/index.html',
      chunks: ['linter'],
      excludeChunks: ['main', 'generate', 'triage'],
    }),
    new HtmlWebpackPlugin({
